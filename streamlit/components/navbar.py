    ...
    st.markdown(
        ...
        <div class="custom-top-nav">
            ...
            <div class="custom-top-nav-right">
                <a class="{home_class}" href="http://localhost:5173/" target="_self">Home</a>
                <a class="{subway_class}" href="http://localhost:5173/subway" target="_self">지하철 분석</a>
                <a class="{airport_class}" href="http://localhost:8501/" target="_self">항공 데이터</a>
            </div>
        </div>
        """,
